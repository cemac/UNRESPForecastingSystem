...
c------------------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0     Level: 141010
c 
...
c --- Error
c      subroutine open_err
c -----------------------------
c
c --- UPDATE
c --- V2.6.0-V2.7.0 141010    :Add error-report for file-open
c                              New     : OPEN_ERR
c --- V2.58-V2.6.0 140318(MBN):Use F95 intrinsic procedures for date and time.
c                              Modified: DATETM
c                              Removed obsolete Compaq, Microsoft, and HP 
c                              compiler codes, and removed getcl
c                              Modified: COMLINE
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 030402               XTRACTLL
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 991104                    YR4
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 020828                   YR4C
c ---            D. Strimaitis,  Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 991104                  QAYR4
c ---            D. Strimaitis,   Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 000602                 JULDAY
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 000602                  GRDAY
c                J. Scire, SRC
c
...
c------------------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 941215                  DEDAT
c ---            J. Scire, SRC
c
...
c------------------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 941215                  DELTT
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 000602                   INCR
c                J. Scire, SRC
c
...
c------------------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 961014                 INDECR
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 061020                  INCRS
c                D. Strimaitis, EARTH TECH
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 041029                DELTSEC
c ---            D. Strimaitis, Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 041029                MIDNITE
c ---            D. Strimaitis, Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 070327                UTCBASR
c ---            F.Robe, Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 070327                BASRUTC
c ---            F.Robe, Earth Tech
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 040330                FILCASE
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 110225                 READIN
c                J. Scire
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 110225                 ALTONU
c ---            J. Scire
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 030402                 DEBLNK
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 030402                 DEPLUS
c ---            J. Scire, Earth Tech, Inc.
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 040330                 TRIGHT
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 040330                  TLEFT
c ---            D. Strimaitis, Earth Tech, Inc.
c
c --- PURPOSE:  Remove all blank characters in the range ilim1 to il2
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 110225                 SETVAR
c ---            J. Scire
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 950122                 ALLCAP
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 140318                 DATETM
c ---            J. Scire
c
c --- PURPOSE:  Get system date and time from system clock, and
c               elapsed CPU time
c --- UPDATES
c --- V2.57-V2.6.0 140318(MBN):Remove obsolete Lahey F77L code,
c                              and etime calls.
...
c --- DATETM calls:      DATE_AND_TIME (F95)
c                        CPU_TIME (F95)
c                        YR4C
c----------------------------------------------------------------------
      character*8  rtime
...
c --- Pass to output formats (MM-DD-YYYY) and (HH:MM:SS)
      ...
      rtime(4:5)=stime(3:4)
      rtime(7:8)=stime(5:6)
c --- Get CPU time from F95 intrinsic procedure
      call CPU_TIME(rcpu1)
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 090511               FMT_DATE
c                D. Strimaitis
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 941215                  ETIME
c ---            J. Scire, SRC
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 030402                UNDRFLW
c                D. Strimaitis,  Earth Tech Inc.
c
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 040330                COMLINE
c                J. Scire, SRC
c
...
c
c --- UPDATE
c --- V2.3 (040330) to V2.6.0 (040330)  MBN
c               - Removed obsolete Compaq, Microsoft, and HP compiler codes
c               - Removed getcl (Lahey-only function not needed)
...
c --- COMLINE calls:      IARGC, GETARG - compiler routines
c                         
c----------------------------------------------------------------------
c
...
c
c ----------------
c --- Intel ifort, Lahey lf95, and GNU gfortran compilers:
c ----------------
      numargs=IARGC()
...
c----------------------------------------------------------------------
c
c --- CALUTILS   Version: 2.7.0    Level: 141010              OPEN_ERR
c               D. Strimaitis, Exponent Inc.
c
c --- PURPOSE:  Report error in opening a file
c
c --- INPUTS:
c               IOLST - integer   - Unit number of output list file
c                                   (<0 if not available)
c               CFROM - char*     - Called-From string to report error
c              CFTYPE - char*     - File-type string
c              CFNAME - char*     - File-name string
c               IUNIT - integer   - File unit number
c
c --- OUTPUT:
c
c --- OPEN_ERR called by:  ()
c --- OPEN_ERR calls:      
c----------------------------------------------------------------------
      implicit none
