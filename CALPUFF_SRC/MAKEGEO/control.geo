...
c-----------------------------------------------------------------------
      ...
      logical lutm,llcc,lps,lem,llaza,lttm,lsnow
      character*80 ctitle

      common /CONTROL/ lqacell,lterr,lutm,llcc,lps,lem,llaza,lttm,llu2,
     &                 lqamiss,lsnow,iflip,nlx,nly,htfac,image,flumin,
     &                 ctitle,ifmtgeo,idatebeg,idateend
...
c lsnow          flag indicating snow data processing                [l]

c ifmtgeo        Varying geo.dat format                              [i]
