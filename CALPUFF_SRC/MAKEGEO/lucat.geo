...
c-----------------------------------------------------------------------
     ...
     &       imiss,imiss2,cfract,nsplit,nincat0,incat0(mxcat),
...
c      ---- Snow related arrays
     &       incats(mxcat),z0lus(mxcat),alblus(mxcat),bowlus(mxcat),
     &       soillus(mxcat),qflus(mxcat),xlailus(mxcat),
     &       mapcats(mxcat)
...
c                  redefined (split)
c nincat0          number of land use categories from LU.DAT header  [i]
c incat0           input land use categories read from LU.DAT header[ia]
...
c  incats,z0lus,alblus,bowlus,soillus,qflus,xlailus,mapcats: Same as
c           incat,z0lu,alblu,bowlu,soillu,qflu,xlailu,mapcat
C  except covered by snow.                                        
