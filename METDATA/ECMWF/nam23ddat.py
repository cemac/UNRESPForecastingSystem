...
for i in range(nfiles):
    filenames.append(filePrefix + fileSuffix)
...
print(varNames)
gidPRMSL = varNames.index("SP_GDS0_SFC") + 1  # Pressure reduced to mean sea level
# Height
