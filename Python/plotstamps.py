...
Figletter = ['a) ', 'b) ', 'c) ', 'd) ', 'e) ', 'f) ', 'g) ', 'h) ', 'j) ',
             'k) ', 'l) ']
filelist = ['2018201806av.txt', '2018201807av.txt', '2018201808av.txt',
            '2018201809av.txt', '2018201810av.txt', '2018201811av.txt',
            '2018201812av.txt', '2019201901av.txt', '2019201902av.txt',
            '2019201903av.txt']
...
cbar = fig.colorbar(concA, cax=cax, cmap=mpt.cmap, norm=mpt.norm, boundaries=[0.] + mpt.binLims
                 + [100000.], extend='both', ticks=mpt.binLims)
